...
for i, row in df.iterrows():
  ...
  axs[i].barh("Positive", positive_bars, color=positive_colours, label=positive_labels[::-1])
  axs[i].barh("Negative", negative_bars, color=negative_colours, label=negative_labels[::-1])
...
axs[0].legend(ncols=7, bbox_to_anchor=(0.5, 2),
...
axs[-1].set_xlabel("Responses, %")
axs[0].legend(ncols=7, bbox_to_anchor=(0.5, 2.5),
  loc='upper center', fontsize='small')
